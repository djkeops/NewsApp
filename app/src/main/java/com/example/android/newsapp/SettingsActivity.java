...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class NewsAppPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        private void bindPreferenceSummaryToValue(Preference preference) {
            // This method takes in a Preference as its parameter, and use setOnPreferenceChangeListener to set the
            // current NewsAppPreferenceFragment instance to listen for changes to the preference that is passed in
